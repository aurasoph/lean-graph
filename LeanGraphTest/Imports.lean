...
import LeanGraph.Tools
import LeanGraph.Imports.Unused
...
LeanGraph.Imports.RequiredModules
-/
#guard_msgs in
#redundant_imports

/-- info: public import LeanGraph.Imports.Redundant -/
#guard_msgs in
#min_imports

/-- info: [LeanGraph.Imports.Redundant] -/
#guard_msgs in
...
/--
info: Transitively unused imports of LeanGraphTest.Used:
  LeanGraphTest.Unused
-/
#guard_msgs in
#unused_transitive_imports LeanGraphTest.Used LeanGraphTest.Unused Init.Control.Reader

elab "#transitivelyRequiredModules_test" : command => do
  let env ← getEnv
  let unused ← liftCoreM <| env.transitivelyRequiredModules `LeanGraph.Imports.RequiredModules
...
elab "#my_test" : command => do
  ...
  let expected := #[`LeanGraph.Imports.RequiredModules]
  ...
  let expected := #[`LeanGraph.Imports.Redundant]
